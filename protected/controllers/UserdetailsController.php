...
class UserdetailsController extends Controller
{
	...
	public function actionView()
	{
		$this->render('view',array(
			'model'=>$this->loadByOpenIDUrl(Yii::app()->user->id),
		));
	}
	...
	{
		$model=Userdetails::model()->findByPk((int)$id);
		if($model===null)
			throw new CHttpException(404,'The requested page does not exist.');
		return $model;
	}

	public function loadByOpenIDUrl($id){
		return Userdetails::model()->getUserByOpenIdUrl($id);
	}
